...
export const cartSlice = createSlice({
  ...
  reducers: {
    addToCart: (state, action) => {
      ...
      state.productsNb = state.productsNb + parseInt(action.payload.quantity);
    },
    removeFromCart: (state, action) => {
      ...
      state.productsNb = state.productsNb - productToRemove.quantity;
    ...
    incrementInCart: (state, action) => {
      ...
      state.productsNb = state.productsNb + 1;
    },
